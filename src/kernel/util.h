...
#include <hmac-sha256/hmac-sha256.h> // HMAC_SHA256_DIGEST_SIZE
...
// input len = message hash len (256 bit -> 32 byte) + counter max size len
// (log(int) = 4) NOTE: int max len differs per compiler (see
