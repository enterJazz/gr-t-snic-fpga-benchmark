...
KERNEL_ASYM_ATTEST_SRCS := $(KERNEL_ASYM_SRC_DIR)/attest.cpp $(KERNEL_ASYM_DEPS_SRCS)
# KERNEL_ASYM_VERIFY_SRCS := $(KERNEL_ASYM_SRC_DIR)/verify.cpp $(KERNEL_ASYM_DEPS_SRCS)
# KERNEL_ASYM_EMPTY_SRCS := $(KERNEL_ASYM_SRC_DIR)/empty.cpp
KERNEL_ASYM_SRCS := $(KERNEL_ASYM_ATTEST_SRCS) #  $(KERNEL_ASYM_VERIFY_SRCS) $(KERNEL_ASYM_EMPTY_SRCS)
...
## execution
HOST_EXEC_ATTEST_KERNEL_SYM_ARGS := -k $(KERNEL_SYM_ATTEST_NAME) -x $(KERNEL_SYM_ATTEST_XCLBIN) -n $(NUM_BENCHMARK_ITERATIONS)
HOST_EXEC_KERNEL_SYM_VERIFY_ARGS := -k $(KERNEL_SYM_VERIFY_NAME) -x $(KERNEL_SYM_VERIFY_XCLBIN) -n $(NUM_BENCHMARK_ITERATIONS)

HOST_EXEC_ATTEST_KERNEL_ASYM_ARGS := -k $(KERNEL_ASYM_ATTEST_NAME) -x $(KERNEL_ASYM_ATTEST_XCLBIN) -n $(NUM_BENCHMARK_ITERATIONS)
...
run-sym-attest-benchmark:
	test -e $(HOST_TARGET)
	# BENCHMARK ATTEST
	XCL_EMULATION_MODE=$(COMPILE_TARGET) $(HOST_TARGET) $(HOST_EXEC_ATTEST_KERNEL_SYM_ARGS)
...
run-asym-attest-benchmark:
	test -e $(HOST_TARGET)
	# BENCHMARK ATTEST
	XCL_EMULATION_MODE=$(COMPILE_TARGET) $(HOST_TARGET) $(HOST_EXEC_ATTEST_KERNEL_ASYM_ARGS)
